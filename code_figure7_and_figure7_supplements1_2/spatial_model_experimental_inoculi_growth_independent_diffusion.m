...
% coefficient for yeast cells. The initial conditions reflect the initial
% conditions in the experiments

function [] = spatial_model_experimental_inoculi_growth_independent_diffusion(r0index)
    ...
    Dy=Dfactor*cellD^2*gmax; % yeast diffusion coefficient
    ...
    save(['data/model_output_stdD_Dg_',num2str(Dg),'_Dt_',num2str(Dt),'_Dy_',num2str(Dy),'_KS_',num2str(KS),'_a1_',num2str(a1),'_a2_',num2str(a2),'_transfers_',num2str(transfers),'_r0_',num2str(r0),'_ring_',num2str(ring),'_dilutionF_',num2str(dilutionF),'_R_',num2str(R),'_dr_',num2str(dr),'_dz_',num2str(dz),'_dt_',num2str(dt),'_n0IC_',num2str(n0IC),'_n0IM_',num2str(n0IM),'_n0RC_',num2str(n0RC),'_n0RM_',num2str(n0RM),'.mat'])
