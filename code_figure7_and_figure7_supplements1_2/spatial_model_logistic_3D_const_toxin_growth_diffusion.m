...
% in Fig. 7 supplement 1C. The initial conditions are idealized and do not
% reflect experimental intial conditions

function [] = spatial_model_logistic_3D_const_toxin_growth_diffusion()
    ...
    for t=1:T
        ...
        for j=2:(N-1) % top - bottom boundary
            ...
            % constant toxin production rate
